    ...
    <div class="all">
      ...
      <h4>TOP FURNITURE TRENDS IN THE MILLENNIUM NEW DIRECTIONS FOR FURNITURE IN THE 21ST CENTURY</h4>
        ...
        <div class="blogcontent">
          <P> </br></br></br> </br>From art market mainstays to persistent provocateu. It was a tall order and a picky search for</br> us, when we tasked ourselves with determining an ultimate list of the greatest living modern </br>artists. Chances are, that the list below will be debated by many but alas…</br></br></br>
        ...
        <div class="div-2">
          <div class="img1">
            <div class="image">
              <img src="./Images/sofa/download (1).jpeg" width="295px" height="200px">
            </div>
          ...
          <div class="img2">
            <div class="image">
              <img src="./Images/sofa/download (2).jpeg" width="295px" height="200px">
            </div>
            <div class="imagetitle">
          ...
          <div class="img3">
            <div class="image">
              <img src="./Images/sofa/download (3).jpeg" width="295px" height="200px">
            </div>
            <div class="imagetitle">
          ...
          <div class="img4">
            <div class="image">
              <img src="./Images/sofa/download.jpeg" width="295px" height="200px">
            </div>
            <div class="imagetitle">
