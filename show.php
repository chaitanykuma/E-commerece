...
<!-- <div class="col-md-6 mb-5 mb-md-0" style="padding-top: 20px; margin-left: 300px;">
				  ...
				  <form action="" method="POST" id="billingdetails">
                    ...
                    <div class="form-group" style="margin-top: 30px;">
		                  <a class="btn btn-black btn-lg py-3 btn-block" href="Address/edit_address.php?address_id=<?php echo $address_id ?>">Edit</a>
						  <a class="btn btn-black btn-lg py-3 btn-block" href="Address/delete.php?address_id=<?php echo $address_id; ?>" onclick='return checkdelete()' >Delete</a>
		                </div></br>
                    </form>
		          <!-- </div>
                </div> -->
